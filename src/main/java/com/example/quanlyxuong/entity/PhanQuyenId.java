...
public class PhanQuyenId implements java.io.Serializable {
    private static final long serialVersionUID = -723171687894797645L;
    @NotNull
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.idVaiTro, entity.idVaiTro) &&
                Objects.equals(this.idNguoiDung, entity.idNguoiDung);
    }

    @Override
    public int hashCode() {
        return Objects.hash(idVaiTro, idNguoiDung);
    }
